...
send(){
  ...
  // }
  $.post('https://mailthis.to/business@prenota.cc', {
  email: this.email,
  _subject:  this.subject,
  message:  this.message,
}).then(function () {
  window.open('https://mailthis.to/confirm', '_blank');
  Notiflix.Report.Success("Grazie!", 'Abbiamo ricevuto la tua email. Ti risponderemo al più presto.', 'OK');
  this.name=''
  this.email=''
  this.subject=''
  this.message=''
  ...
  //     Notiflix.Report.Success("Grazie!", 'Abbiamo ricevetula tua email. Ti risponderemo al più presto', 'OK');
  //     this.name=''
  //     this.email=''
  //     this.subject=''
  //     this.message=''
...
website(){
  ...
  if(this.make_website){ 
    this.price_SMALL= 29
    this.price_MEDIUM= 49
  }else{
      this.price_SMALL= 19
      this.price_MEDIUM= 39
  }
}
