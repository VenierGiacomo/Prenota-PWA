...
@Component({
  selector: "app-studi-di-unghie",
  templateUrl: "./studi-di-unghie.component.html",
  styleUrls: ["./studi-di-unghie.component.scss"]
},)
export class StudiDiUnghieComponent implements OnInit {
...
{name: "Sara MLBN", address: "Via delle Settefontane 20, Trieste (TS)", phone: "+39 349 102 0651", verified: false, url: "/unghie/trieste/Sara%20MLBN/9"},
 ...
 {name:"Magic Nails",address:"Corso Italia 26, Trieste (TS)",phone:'+39 366 291 1184', verified:false, url: "/unghie/trieste/Magic%20Nails/45"},
  ...
  constructor(private metaService: Meta, private titleService: Title) {
    this.titleService.setTitle("Unghie a Trieste 💅🏼 - Lista completa con numeri di telefono")
    var metaTags=[
      {property: "og:url", content: "https://prenota.cc/unghie/trieste"},
      {property: "og:title", content: "Unghie a Trieste 💅🏼 - Lista completa di studi con numeri di telefono"},
      {property: "og:description", content: "Studi professinali di ricostruzione unghie, manicure, pedicure ed applicazione gel semipermanente. Trova il nail artist che fa per te"},
      ...
      {name: 'keywords', content:  "unghie trieste, nails art trieste, nail art trieste, nails trieste, nails artist trieste, gel semipermanente trieste, ricostruzione unghie trieste, manicure trieste , riscotruzione unghie gel  trieste, unghie gel trieste,nails art trieste, applicazione smalto trieste,smalto semipermanente trieste, manicure trieste, pedicure trieste,  unghie artificali , unghie finte trieste, smalto acrilico trieste, onicotecnica unghie trieste, smalto permanente trieste"},
      {name: "description", content: "Studi professinali di ricostruzione unghie, manicure, pedicure ed applicazione gel semipermanente. Trova il nail artist che fa per te"},
